...
class CAddInNative : public IComponentBase {
    ...
    public:
        ...
        //My Method's:
        virtual bool ADDIN_API log(std::string str);
        virtual bool ADDIN_API logTo1C(WCHAR_T *who, WCHAR_T *what, WCHAR_T *wdata);
        virtual bool ADDIN_API logIn1C (std::string str);
